...
<html>
    <head>
        ...
        <link href="<?php echo $path; ?>Theme/<?php echo $theme; ?>/emon-srh.css" rel="stylesheet">
                ...
                <div class="navbar-inner">
                    <?php if ($menucollapses) { ?>
                        <style>
                            ...
                            @media (min-width: 980px) and (max-width: <?php
                            if ($maxwidth1 < 981) {
                                $maxwidth1 = 981;
                            } echo $maxwidth1;
                            ?>px){
                        ...
                        <?php } ?>
                        <?php if ($route->action != 'login') { ?><img class="menu-logo" src="<?php echo $path; ?>Theme/srh/logo_normal.png" /><?php } ?>
                        <?php
                        echo $mainmenu;
                        ?>
                        <?php
